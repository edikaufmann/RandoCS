...
public partial class AppShell : Shell
{
    ...
    void RegisterRoutes()
    {
        Routes.Add("varhautedetails", typeof(VARHauteDetailPage));
        Routes.Add("alpesdehauteprovencedetails", typeof(AlpesdeHauteProvenceDetailPage));
       
        Routes.Add("MotivationPage", typeof(MotivationPage));
